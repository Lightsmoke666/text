...
-- 自动打ATM功能函数
local function autoATMFunction()
...
-- 自动管理变量
local autouse = false   -- 自动使用消耗品
local autosell = false  -- 自动售卖物品
local autorem = false   -- 自动清理垃圾
